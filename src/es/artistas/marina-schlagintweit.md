---
title: 'Marina Schlagintweit'
translationKey: 'marinaschlagintweit'
customSlug: 'marina-schlagintweit'
excerpt: Marina Schlagintweit es una pianista y compositora de jazz que, desde hace dos años, abre caminos artísticos nuevos en la escena musical de Leipzig en varios proyectos.
occupation: 'pianista y compositora de jazz'
images: # complete path for eleventy img srcset output, alt required
  featured: ./src/assets/images/artists/marina-schlagintweit-lukas-diller.jpg
  alt: Marina Schlagintweit
  credit: Lukas Diller
links:
  web: https://www.marinasibyll.de
---
